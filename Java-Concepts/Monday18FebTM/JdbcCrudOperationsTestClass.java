...
public class JdbcCrudOperationsTestClass {
    static String url = "jdbc:mysql://localhost:3306/techm";
    static String username = "root";
    // Give the password to access MySQL server
    static String password = "MadhanKumar&4567";
    ...
    public static void selectRecordsWithPreparedStatement(int id) throws SQLException {
        ...
        Connection connection = DriverManager.getConnection(url, username, password);
        // Step 2 - Creating statement
        PreparedStatement pstmt = connection.prepareStatement("select emp_id, emp_name from employee where emp_id=?");
        pstmt.setInt(1, id);
